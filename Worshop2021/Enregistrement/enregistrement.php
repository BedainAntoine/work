				...
				<form>
					...
					<div class="inp">
						<select name="groupe" id="situation">
							...
							<option valeur="logement">Un loueur</option>
...
@mysqli_select_db($BD_base)
	...
	if(isset($_POST['adresseMail'],$_POST['mdp'])){
		if(empty($_POST['adresseMail'])){
			...
			if(!mysqli_query($mysqli, "INSERT INTO user SET adresseMail='".$_POST['adresseMail']."', mdp='".md5($_POST['mdp'])."', prenom='".$_POST['prenom']."', nom='".$_POST['nom']."', age='".$_POST['age']."', telephone='".$_POST['telephone']."'")){
				echo "Une erreur s'est produite: ";//.mysqli_error($mysqli);
			} else {
				mysqli_query($bdd, "INSERT INTO adresse SET adresse='".$_POST['adresse']."'");
